...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    espritSignatureAuthUserSubject.add(
      EspritSignatureAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<EspritSignatureAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  EspritSignatureAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = EspritSignatureAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    espritSignatureAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
EspritSignatureAuthUser? currentUser;
