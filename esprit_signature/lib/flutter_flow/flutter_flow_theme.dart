...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFF808080);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF333333);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF2F2F2);
  late Color accent1 = const Color(0xFFFF9999);
  late Color accent2 = const Color(0xFFFFCCCC);
  late Color accent3 = const Color(0xFF4D4D4D);
  late Color accent4 = const Color(0xFFBFBFBF);
  late Color success = const Color(0xFF66FF99);
  late Color warning = const Color(0xFFFFCC66);
  late Color error = const Color(0xFFFF6666);
  late Color info = const Color(0xFF6699FF);
